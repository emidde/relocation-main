  ...
  return (
    <div className="home dark:bg-white">
      ...
      <div className="container-relocation">
        ...
        <div className="buttons-header md:flex sm:flex sm:justify-around md:justify-start">
        ...
        <div className="">
          ...
          <div className="w-full md:flex md:items-center sm:mt-20">
            ...
            <div className="md:w-1/2 sl:w-full">
              <div className="trabalha-ti sm:text-3xl sm:font-bold sm:leading-normal">
...
Já deixamos pronto o kit pet com ração de sua preferência, comedouro, caminha, coleira, caixinha de areia e outros utencílios que precisar.  
              ...
              <div className="button-saiba-mais   dogsButton sm:pb-10" style={{textAlign:'-moz-center'}}>
                ...
                <button className='flex gap-x-2' ><FaDog size="20px"/> Transporte Pet Internacional</button>
                </CustomLink>
              </div>
          </div>
        </div>
        ...
        <div className="best-places">
          ...
          <div className="places-area md:flex md:items-center md:justify-around sm:block sm:text-center ">
            <div className="place">
