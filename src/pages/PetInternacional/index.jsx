...
const PetInternacioanal = () => {
  ...
  return (
    <div className="container-relocation">
        ...
        <div className="text-5xl text-violet-900 pt-3">
            <h2><b>Informações importante</b></h2>
        </div>
        <div>
            <h3 className='flex gap-x-4'>
                <span className='flex gap-x-4 items-center text-4xl pt-8'><FaPaw color='#6F2185' /><b className='text-violet-800'>Planejar</b></span>
            </h3>
            <p className='font-medium pt-4 text-justify text-base pb-4 text-gray-900'>
            ...
            <div>
                <ol type='I'>
                    {planejamento.map((item) => (
                        <li className='flex gap-x-2 items-center text-justify px-12 py-2 text-normal font-normal text-gray-700'>
                            <p><FaCircle size="10px"/></p>
                            <p>{item.passo}</p></li>
                    ))}
                </ol>
                <p className='font-medium pt-4 text-justify text-base pb-4 text-gray-900'>
        ...
        <div>
            <h3 className='flex gap-x-4'>
                <span className='flex gap-x-4 items-center text-4xl pt-8'><FaPaw color='#6F2185' /><b className='text-violet-800'>Documentação necessária</b></span>
            </h3>
            <p className='font-medium pt-4 text-justify text-base pb-4 text-gray-900'>
...
Exemplo de caixa de transporte:      <br></br><br></br>       </p>
        ...
        <div>
            <h3 className='flex gap-x-4'>
                <span className='flex gap-x-4 items-center text-4xl pt-8'><FaPaw color='#6F2185' /><b className='text-violet-800'>Como medir o animal de estimação?</b></span>
            </h3>
            <div className='pt-4'>
                <ol type='I'>
                    {medidas.map((item) => (
        ...
        <div>
            <h3 className='flex gap-x-4'>
                <span className='flex gap-x-4 items-center text-4xl pt-8'><FaPaw color='#6F2185' /><b className='text-violet-800'>Condições de transporte para animais perigosos</b></span>
            </h3>
            <p className='font-medium pt-4 text-justify text-base pb-4 text-gray-900'>
